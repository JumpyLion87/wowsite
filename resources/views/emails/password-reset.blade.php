                    ...
                    <tr>
                        <td style="padding: 30px; background-color: #2d2d2d;">
                            ...
                            <p style="color: #d4af37; font-size: 18px; font-weight: bold; margin: 0 0 20px 0;">
                                {{ __('auth.password_reset_greeting', ['username' => $username]) }}
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 25px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $resetUrl }}" style="display: inline-block; background: linear-gradient(135deg, #d4af37 0%, #ffd700 50%, #d4af37 100%); color: #1a1a1a; padding: 16px 32px; text-decoration: none; border-radius: 12px; font-weight: bold; font-size: 18px; border: 2px solid #8b4513; box-shadow: 0 4px 15px rgba(212, 175, 55, 0.4);">
                            ...
                            <p style="color: #a0a0a0; font-size: 14px; margin: 0 0 15px 0;">
                                {{ __('auth.password_reset_alternative') }}
                            </p>
                    ...
                    <tr>
                        <td style="padding: 25px 30px; text-align: center; background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%); border-radius: 0 0 12px 12px; border-top: 2px solid #8b4513;">
                            <p style="color: #a0a0a0; font-size: 14px; margin: 0 0 10px 0;">
                                {{ __('auth.password_reset_security') }}
                            </p>
                            <p style="color: #666; font-size: 12px; margin: 0;">
                                &copy; {{ date('Y') }} {{ $siteName }}. {{ __('auth.password_reset_footer') }}
                            </p>
                        </td>
                    </tr>
