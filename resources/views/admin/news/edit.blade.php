...
@section('title', __('admin_news.edit_news'))
    ...
    <div class="admin-header">
        <div class="admin-header-content">
            <h1 class="admin-title">
                ...
                {{ __('admin_news.edit_news') }}
            </h1>
            <p class="admin-subtitle">{{ __('admin_news.edit_news_description') }}</p>
        </div>
    ...
    <div class="admin-content">
        <div class="content-card">
            ...
            <div class="content-body">
                <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data" class="news-form">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="post_date" name="post_date" 
                                   value="{{ old('post_date', $news->post_date->format('Y-m-d\TH:i')) }}" 
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" id="is_important" name="is_important" 
                                   ...
                                   {{ old('is_important', $news->is_important) ? 'checked' : '' }}>
